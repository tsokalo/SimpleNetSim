...
#ifndef CCACK_TEST_CCACK_REDUNDANCY_MONTE_CARLO_H_
#define CCACK_TEST_CCACK_REDUNDANCY_MONTE_CARLO_H_
...
void TestCcackRedundancyMonteCarlo() {
...
#endif /* CCACK_TEST_CCACK_REDUNDANCY_MONTE_CARLO_H_ */
