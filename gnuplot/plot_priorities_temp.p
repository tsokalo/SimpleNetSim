...
"./gnuplot/data.txt" every 10 using ($1):(($2==4) ? $3/1000000 : 1/0) with linespoints ls 1 lw 1 linecolor 5 pt 7 ps 0.3 title "vertex=4",\
"./gnuplot/data.txt" every 10 using ($1):(($2==5) ? $3/1000000 : 1/0) with linespoints ls 1 lw 1 linecolor 6 pt 7 ps 0.3 title "vertex=5",\
"./gnuplot/data.txt" every 10 using ($1):(($2==6) ? $3/1000000 : 1/0) with linespoints ls 1 lw 1 linecolor 7 pt 7 ps 0.3 title "vertex=6",\
"./gnuplot/data.txt" every 10 using ($1):(($2==7) ? $3/1000000 : 1/0) with linespoints ls 1 lw 1 linecolor 8 pt 7 ps 0.3 title "vertex=7",\
